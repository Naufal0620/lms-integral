...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white dark:bg-slate-900 rounded-[2.5rem] overflow-hidden shadow-2xl border-2 border-slate-100 dark:border-white/5 transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
        x-transition:enter="ease-out duration-300"
